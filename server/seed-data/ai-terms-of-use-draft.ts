 ...
 *   - The age floor matches the product: 13 to register independently, and an athlete under 13
 *     through a coach-provisioned account with a guardian's linked account in place. That is
 *     exactly what tier1_under13 plus the guardian gate actually do.
 ...
 *
 * STILL NOT WIRED TO ANYTHING, and still deliberately so. Not a legalDocuments type, not seeded,
 * not shown, not accepted by anybody; a test holds it that way. Three things are unresolved:
 *
 * 1. THE INDEMNIFICATION CLAUSE IS UNQUALIFIED AS TO MINORS. "The User agrees to indemnify and
 *    hold the Company harmless" -- where the User is a fourteen-year-old athlete, several states
 *    limit or void an indemnification obligation imposed on a minor. This is the same question
 *    already flagged in TERMS_OF_SERVICE_DRAFT's own placeholder, unchanged by moving it here.
 *
 * 2. IT DROPS THE MINOR-RIGHTS CARVE-OUT that every other Forge document carries. See
 *    GOVERNING_LAW_CLAUSE: "Nothing here waives a right that cannot lawfully be waived,
 *    including a right belonging to a person under 18." Beside an unqualified indemnification
 *    clause that sentence matters more, not less.
 *
 * 3. "THE SERVICE" IS NOT DEFINED AGAINST FORGE ITSELF. It reads "our artificial intelligence
 *    service", but Forge is a training platform WITH AI features, not an AI service. Whether
 *    these Terms govern only the AI features or the whole platform decides whether this is a
 *    narrow supplement to the signup agreement or a second general agreement competing with it.
 *    Scoped to the AI features it is clean; left ambiguous it recreates the two-documents
 *    problem it was meant to help end.
 */
export const AI_TERMS_OF_USE = `Artificial Intelligence Terms of Use

Acceptance of the Terms of Use. This Artificial Intelligence Terms of Use ("Terms") is made effective as of September 17, 2026, by and between you ("User") and Forge Performance Systems LLC ("Company"). By accessing and using our artificial intelligence service ("Service"), the User acknowledges that the User has read, understood, and agreed to be bound by the following Terms and the Company Privacy Policy. If the User does not agree to these Terms, the User may not use the Service.

Age Requirements. The User must be at least 13 years or older to independently register and use the Service. An athlete under 13 may use the Service only through an account provisioned by their coach, with a parent or legal guardian's linked account in place. If the User is under 18 years of age, they must have their parent or legal guardian's permission to use the Service.
...
Indemnification. The User agrees to indemnify and hold the Company harmless from all claims, losses, expenses, and fees, including attorney fees, costs, and judgments that may be asserted against the Company resulting from any act or omission of the User and their employees, agents, or representatives.
