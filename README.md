...
- Free Agent (athlete with no coach, full AI program building): `freeagent@forge.app` / `freeagent123`
...
5. Once live, log in with the seeded demo accounts (`coach@forge.app` / `coach123`,
   `athlete@forge.app` / `athlete123`, and `freeagent@forge.app` / `freeagent123`), or sign
   up fresh accounts from the app itself.
