 ...
 * route as-is for the actual markup step -- this dialog just persists the
 * resulting imageUrl. */
export function SkillSessionsDialog({
  open,
  onOpenChange,
  athleteName,
  athleteId,
        ...
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              {athleteName}'s Skill Clips
            </DialogTitle>
            <DialogDescription>
              Saved swing/throw clips this athlete chose to share -- draw on a frame to leave feedback.
            </DialogDescription>
          </DialogHeader>
